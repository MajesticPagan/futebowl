			...
			>
				<div className="p-4 md:p-6 border border-gray-700 rounded shadow">
					...
					<div className="flex items-center mt-4 space-x-3">
						<svg
							className="text-gray-700 w-14 h-14"
							aria-hidden="true"
							fill="currentColor"
							viewBox="0 0 20 20"
							xmlns="http://www.w3.org/2000/svg"
				...
				{data?.map((item) => (
					<Card hover key={item.Title}>
						...
						<div className="mt-6">
							...
							<p className="mb-6 font-normal text-gray-400">{item.PublisherName}</p>
							<a
								href={item.NewsLink}
								className="inline-flex justify-center items-center py-2 px-4 text-base font-medium text-center rounded text-white bg-blue-600 hover:bg-blue-700 focus:ring-2 focus:ring-blue-900"
							>
								Ler mais
							</a>
						</div>
